        ...
        <div className="relative bg-white h-full w-[80vw] pt-20 z-10">
          ...
          <div className="mx-15">
            ...
            <div className="flex mt-3 justify-center gap-10 mb-5">
              ...
              <div className="font-bold pl-7 flex flex-col">
                ...
                <div className="flex justify-between items-center gap-3 w-full min-w-[500px]">
                  <a href="https://www.gov.wales/rural-grants-and-payments-geotagged-photo-guidance#121535">
                  ...
                  <div className="">
                    ...
                    >
                      <img src={folder} alt="" className="h-6 mr-1" /> Choose
                      File
                    </label>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="absolute inset-0 w-125 h-63 object-contain bg-black shadow-md text-white flex items-center justify-center">
                    No Image Selected
                  </div>
                  {preview && (
                    <img
            ...
            <div className="flex justify-between pt-1">
              ...
              <button
                type="submit"
                className="px-4 py-1 rounded-xl text-2xl bg-black text-white front-bold cursor-pointer mr-3"
              >
                Submit Report
              </button>
            </div>
